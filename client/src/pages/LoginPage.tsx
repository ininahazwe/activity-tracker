      ...
      >
        <div className="w-[420px] px-4">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="nav-text-primary text-2xl font-extrabold">Results & Impact Tracker</h1>
            <p className="nav-text-muted text-sm mt-1">Sign in to your account</p>
          </div>
          ...
          >
            <div className="mb-5">
              <label className="block nav-text-muted text-[11px] font-semibold uppercase tracking-wide mb-1.5">
                Email
              </label>
              <input
                  type="email"
            ...
            <div className="mb-6">
              <div className="flex justify-between mb-1.5">
                <label className="nav-text-muted text-[11px] font-semibold uppercase tracking-wide">
                  Password
                </label>
          ...
          <p className="text-center nav-text-muted text-xs mt-5">
